#ifndef GL_HPP_GL_VERSION_3_0_HPP
#define GL_HPP_GL_VERSION_3_0_HPP
#include "common.hpp"
...
{
	static PFNGLBEGINCONDITIONALRENDERPROC_HPP fn=reinterpret_cast<PFNGLBEGINCONDITIONALRENDERPROC_HPP>(_impl::_get_proc_address("glBeginConditionalRender",3,0));
	 fn(id1,mode1);
}
...
{
	static PFNGLBINDFRAGDATALOCATIONPROC_HPP fn=reinterpret_cast<PFNGLBINDFRAGDATALOCATIONPROC_HPP>(_impl::_get_proc_address("glBindFragDataLocation",3,0));
...
{
	static PFNGLCLAMPCOLORPROC_HPP fn=reinterpret_cast<PFNGLCLAMPCOLORPROC_HPP>(_impl::_get_proc_address("glClampColor",3,0));
	 fn(target1,clamp1);
}
...
{
	static PFNGLCLIENTACTIVETEXTUREPROC_HPP fn=reinterpret_cast<PFNGLCLIENTACTIVETEXTUREPROC_HPP>(_impl::_get_proc_address("glClientActiveTexture",3,0));
	 fn(texture1);
}
...
{
	static PFNGLCOLORMASKIPROC_HPP fn=reinterpret_cast<PFNGLCOLORMASKIPROC_HPP>(_impl::_get_proc_address("glColorMaski",3,0));
...
{
	static PFNGLCOMPRESSEDTEXIMAGE1DPROC_HPP fn=reinterpret_cast<PFNGLCOMPRESSEDTEXIMAGE1DPROC_HPP>(_impl::_get_proc_address("glCompressedTexImage1D",3,0));
...
{
	static PFNGLCOMPRESSEDTEXSUBIMAGE1DPROC_HPP fn=reinterpret_cast<PFNGLCOMPRESSEDTEXSUBIMAGE1DPROC_HPP>(_impl::_get_proc_address("glCompressedTexSubImage1D",3,0));
...
{
	static PFNGLDISABLEIPROC_HPP fn=reinterpret_cast<PFNGLDISABLEIPROC_HPP>(_impl::_get_proc_address("glDisablei",3,0));
	 fn(target1,index1);
}
...
{
	static PFNGLENABLEIPROC_HPP fn=reinterpret_cast<PFNGLENABLEIPROC_HPP>(_impl::_get_proc_address("glEnablei",3,0));
	 fn(target1,index1);
}
...
{
	static PFNGLENDCONDITIONALRENDERPROC_HPP fn=reinterpret_cast<PFNGLENDCONDITIONALRENDERPROC_HPP>(_impl::_get_proc_address("glEndConditionalRender",3,0));
	 fn();
}
...
{
	static PFNGLFOGCOORDPOINTERPROC_HPP fn=reinterpret_cast<PFNGLFOGCOORDPOINTERPROC_HPP>(_impl::_get_proc_address("glFogCoordPointer",3,0));
	 fn(type1,stride1,pointer1);
}
typedef void (*PFNGLFOGCOORDDPROC_HPP)(GLdouble);
static inline void FogCoordd(GLdouble coord1)
{
	static PFNGLFOGCOORDDPROC_HPP fn=reinterpret_cast<PFNGLFOGCOORDDPROC_HPP>(_impl::_get_proc_address("glFogCoordd",3,0));
	 fn(coord1);
}
typedef void (*PFNGLFOGCOORDDVPROC_HPP)(const GLdouble *);
static inline void FogCoorddv(const GLdouble * coord1)
{
	static PFNGLFOGCOORDDVPROC_HPP fn=reinterpret_cast<PFNGLFOGCOORDDVPROC_HPP>(_impl::_get_proc_address("glFogCoorddv",3,0));
	 fn(coord1);
}
typedef void (*PFNGLFOGCOORDFPROC_HPP)(GLfloat);
static inline void FogCoordf(GLfloat coord1)
{
	static PFNGLFOGCOORDFPROC_HPP fn=reinterpret_cast<PFNGLFOGCOORDFPROC_HPP>(_impl::_get_proc_address("glFogCoordf",3,0));
	 fn(coord1);
}
typedef void (*PFNGLFOGCOORDFVPROC_HPP)(const GLfloat *);
static inline void FogCoordfv(const GLfloat * coord1)
{
	static PFNGLFOGCOORDFVPROC_HPP fn=reinterpret_cast<PFNGLFOGCOORDFVPROC_HPP>(_impl::_get_proc_address("glFogCoordfv",3,0));
	 fn(coord1);
}
...
{
	static PFNGLFRAMEBUFFERTEXTURE1DPROC_HPP fn=reinterpret_cast<PFNGLFRAMEBUFFERTEXTURE1DPROC_HPP>(_impl::_get_proc_address("glFramebufferTexture1D",3,0));
...
{
	static PFNGLFRAMEBUFFERTEXTURE3DPROC_HPP fn=reinterpret_cast<PFNGLFRAMEBUFFERTEXTURE3DPROC_HPP>(_impl::_get_proc_address("glFramebufferTexture3D",3,0));
...
{
	static PFNGLGETBOOLEANI_VPROC_HPP fn=reinterpret_cast<PFNGLGETBOOLEANI_VPROC_HPP>(_impl::_get_proc_address("glGetBooleani_v",3,0));
...
{
	static PFNGLGETBUFFERSUBDATAPROC_HPP fn=reinterpret_cast<PFNGLGETBUFFERSUBDATAPROC_HPP>(_impl::_get_proc_address("glGetBufferSubData",3,0));
	 fn(target1,offset1,size1,data1);
}
...
{
	static PFNGLGETCOMPRESSEDTEXIMAGEPROC_HPP fn=reinterpret_cast<PFNGLGETCOMPRESSEDTEXIMAGEPROC_HPP>(_impl::_get_proc_address("glGetCompressedTexImage",3,0));
...
{
	static PFNGLGETQUERYOBJECTIVPROC_HPP fn=reinterpret_cast<PFNGLGETQUERYOBJECTIVPROC_HPP>(_impl::_get_proc_address("glGetQueryObjectiv",3,0));
...
{
	static PFNGLGETTEXPARAMETERIIVPROC_HPP fn=reinterpret_cast<PFNGLGETTEXPARAMETERIIVPROC_HPP>(_impl::_get_proc_address("glGetTexParameterIiv",3,0));
	 fn(target1,pname1,params1);
}
...
{
	static PFNGLGETTEXPARAMETERIUIVPROC_HPP fn=reinterpret_cast<PFNGLGETTEXPARAMETERIUIVPROC_HPP>(_impl::_get_proc_address("glGetTexParameterIuiv",3,0));
	 fn(target1,pname1,params1);
}
...
{
	static PFNGLGETVERTEXATTRIBDVPROC_HPP fn=reinterpret_cast<PFNGLGETVERTEXATTRIBDVPROC_HPP>(_impl::_get_proc_address("glGetVertexAttribdv",3,0));
	 fn(index1,pname1,params1);
}
...
{
	static PFNGLISENABLEDIPROC_HPP fn=reinterpret_cast<PFNGLISENABLEDIPROC_HPP>(_impl::_get_proc_address("glIsEnabledi",3,0));
...
{
	static PFNGLLOADTRANSPOSEMATRIXDPROC_HPP fn=reinterpret_cast<PFNGLLOADTRANSPOSEMATRIXDPROC_HPP>(_impl::_get_proc_address("glLoadTransposeMatrixd",3,0));
	 fn(m1);
}
typedef void (*PFNGLLOADTRANSPOSEMATRIXFPROC_HPP)(const GLfloat *);
static inline void LoadTransposeMatrixf(const GLfloat * m1)
{
	static PFNGLLOADTRANSPOSEMATRIXFPROC_HPP fn=reinterpret_cast<PFNGLLOADTRANSPOSEMATRIXFPROC_HPP>(_impl::_get_proc_address("glLoadTransposeMatrixf",3,0));
	 fn(m1);
}
...
{
	static PFNGLMAPBUFFERPROC_HPP fn=reinterpret_cast<PFNGLMAPBUFFERPROC_HPP>(_impl::_get_proc_address("glMapBuffer",3,0));
...
{
	static PFNGLMULTTRANSPOSEMATRIXDPROC_HPP fn=reinterpret_cast<PFNGLMULTTRANSPOSEMATRIXDPROC_HPP>(_impl::_get_proc_address("glMultTransposeMatrixd",3,0));
	 fn(m1);
}
typedef void (*PFNGLMULTTRANSPOSEMATRIXFPROC_HPP)(const GLfloat *);
static inline void MultTransposeMatrixf(const GLfloat * m1)
{
	static PFNGLMULTTRANSPOSEMATRIXFPROC_HPP fn=reinterpret_cast<PFNGLMULTTRANSPOSEMATRIXFPROC_HPP>(_impl::_get_proc_address("glMultTransposeMatrixf",3,0));
	 fn(m1);
}
...
{
	static PFNGLMULTIDRAWARRAYSPROC_HPP fn=reinterpret_cast<PFNGLMULTIDRAWARRAYSPROC_HPP>(_impl::_get_proc_address("glMultiDrawArrays",3,0));
...
{
	static PFNGLMULTIDRAWELEMENTSPROC_HPP fn=reinterpret_cast<PFNGLMULTIDRAWELEMENTSPROC_HPP>(_impl::_get_proc_address("glMultiDrawElements",3,0));
...
{
	static PFNGLMULTITEXCOORD1DPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD1DPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord1d",3,0));
	 fn(target1,s1);
}
...
{
	static PFNGLMULTITEXCOORD1DVPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD1DVPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord1dv",3,0));
	 fn(target1,v1);
}
typedef void (*PFNGLMULTITEXCOORD1FPROC_HPP)(GLenum,GLfloat);
static inline void MultiTexCoord1f(GLenum target1,GLfloat s1)
{
	static PFNGLMULTITEXCOORD1FPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD1FPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord1f",3,0));
	 fn(target1,s1);
}
...
{
	static PFNGLMULTITEXCOORD1FVPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD1FVPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord1fv",3,0));
	 fn(target1,v1);
}
typedef void (*PFNGLMULTITEXCOORD1IPROC_HPP)(GLenum,GLint);
static inline void MultiTexCoord1i(GLenum target1,GLint s1)
{
	static PFNGLMULTITEXCOORD1IPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD1IPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord1i",3,0));
	 fn(target1,s1);
}
...
{
	static PFNGLMULTITEXCOORD1IVPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD1IVPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord1iv",3,0));
	 fn(target1,v1);
}
typedef void (*PFNGLMULTITEXCOORD1SPROC_HPP)(GLenum,GLshort);
static inline void MultiTexCoord1s(GLenum target1,GLshort s1)
{
	static PFNGLMULTITEXCOORD1SPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD1SPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord1s",3,0));
	 fn(target1,s1);
}
...
{
	static PFNGLMULTITEXCOORD1SVPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD1SVPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord1sv",3,0));
	 fn(target1,v1);
}
...
{
	static PFNGLMULTITEXCOORD2DPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD2DPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord2d",3,0));
	 fn(target1,s1,t1);
}
...
{
	static PFNGLMULTITEXCOORD2DVPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD2DVPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord2dv",3,0));
	 fn(target1,v1);
}
...
{
	static PFNGLMULTITEXCOORD2FPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD2FPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord2f",3,0));
	 fn(target1,s1,t1);
}
...
{
	static PFNGLMULTITEXCOORD2FVPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD2FVPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord2fv",3,0));
	 fn(target1,v1);
}
...
{
	static PFNGLMULTITEXCOORD2IPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD2IPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord2i",3,0));
	 fn(target1,s1,t1);
}
...
{
	static PFNGLMULTITEXCOORD2IVPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD2IVPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord2iv",3,0));
	 fn(target1,v1);
}
...
{
	static PFNGLMULTITEXCOORD2SPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD2SPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord2s",3,0));
	 fn(target1,s1,t1);
}
...
{
	static PFNGLMULTITEXCOORD2SVPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD2SVPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord2sv",3,0));
	 fn(target1,v1);
}
...
{
	static PFNGLMULTITEXCOORD3DPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD3DPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord3d",3,0));
	 fn(target1,s1,t1,r1);
}
...
{
	static PFNGLMULTITEXCOORD3DVPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD3DVPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord3dv",3,0));
	 fn(target1,v1);
}
...
{
	static PFNGLMULTITEXCOORD3FPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD3FPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord3f",3,0));
	 fn(target1,s1,t1,r1);
}
...
{
	static PFNGLMULTITEXCOORD3FVPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD3FVPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord3fv",3,0));
	 fn(target1,v1);
}
...
{
	static PFNGLMULTITEXCOORD3IPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD3IPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord3i",3,0));
	 fn(target1,s1,t1,r1);
}
...
{
	static PFNGLMULTITEXCOORD3IVPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD3IVPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord3iv",3,0));
	 fn(target1,v1);
}
...
{
	static PFNGLMULTITEXCOORD3SPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD3SPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord3s",3,0));
	 fn(target1,s1,t1,r1);
}
...
{
	static PFNGLMULTITEXCOORD3SVPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD3SVPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord3sv",3,0));
	 fn(target1,v1);
}
...
{
	static PFNGLMULTITEXCOORD4DPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD4DPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord4d",3,0));
...
{
	static PFNGLMULTITEXCOORD4DVPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD4DVPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord4dv",3,0));
	 fn(target1,v1);
}
...
{
	static PFNGLMULTITEXCOORD4FPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD4FPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord4f",3,0));
	 fn(target1,s1,t1,r1,q1);
}
...
{
	static PFNGLMULTITEXCOORD4FVPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD4FVPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord4fv",3,0));
	 fn(target1,v1);
}
...
{
	static PFNGLMULTITEXCOORD4IPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD4IPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord4i",3,0));
	 fn(target1,s1,t1,r1,q1);
}
...
{
	static PFNGLMULTITEXCOORD4IVPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD4IVPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord4iv",3,0));
	 fn(target1,v1);
}
...
{
	static PFNGLMULTITEXCOORD4SPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD4SPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord4s",3,0));
	 fn(target1,s1,t1,r1,q1);
}
...
{
	static PFNGLMULTITEXCOORD4SVPROC_HPP fn=reinterpret_cast<PFNGLMULTITEXCOORD4SVPROC_HPP>(_impl::_get_proc_address("glMultiTexCoord4sv",3,0));
	 fn(target1,v1);
}
...
{
	static PFNGLPOINTPARAMETERFPROC_HPP fn=reinterpret_cast<PFNGLPOINTPARAMETERFPROC_HPP>(_impl::_get_proc_address("glPointParameterf",3,0));
	 fn(pname1,param1);
}
...
{
	static PFNGLPOINTPARAMETERFVPROC_HPP fn=reinterpret_cast<PFNGLPOINTPARAMETERFVPROC_HPP>(_impl::_get_proc_address("glPointParameterfv",3,0));
	 fn(pname1,params1);
}
typedef void (*PFNGLPOINTPARAMETERIPROC_HPP)(GLenum,GLint);
static inline void PointParameteri(GLenum pname1,GLint param1)
{
	static PFNGLPOINTPARAMETERIPROC_HPP fn=reinterpret_cast<PFNGLPOINTPARAMETERIPROC_HPP>(_impl::_get_proc_address("glPointParameteri",3,0));
	 fn(pname1,param1);
}
...
{
	static PFNGLPOINTPARAMETERIVPROC_HPP fn=reinterpret_cast<PFNGLPOINTPARAMETERIVPROC_HPP>(_impl::_get_proc_address("glPointParameteriv",3,0));
	 fn(pname1,params1);
}
...
{
	static PFNGLSECONDARYCOLOR3BPROC_HPP fn=reinterpret_cast<PFNGLSECONDARYCOLOR3BPROC_HPP>(_impl::_get_proc_address("glSecondaryColor3b",3,0));
...
{
	static PFNGLSECONDARYCOLOR3BVPROC_HPP fn=reinterpret_cast<PFNGLSECONDARYCOLOR3BVPROC_HPP>(_impl::_get_proc_address("glSecondaryColor3bv",3,0));
	 fn(v1);
}
...
{
	static PFNGLSECONDARYCOLOR3DPROC_HPP fn=reinterpret_cast<PFNGLSECONDARYCOLOR3DPROC_HPP>(_impl::_get_proc_address("glSecondaryColor3d",3,0));
	 fn(red1,green1,blue1);
}
typedef void (*PFNGLSECONDARYCOLOR3DVPROC_HPP)(const GLdouble *);
static inline void SecondaryColor3dv(const GLdouble * v1)
{
	static PFNGLSECONDARYCOLOR3DVPROC_HPP fn=reinterpret_cast<PFNGLSECONDARYCOLOR3DVPROC_HPP>(_impl::_get_proc_address("glSecondaryColor3dv",3,0));
	 fn(v1);
}
...
{
	static PFNGLSECONDARYCOLOR3FPROC_HPP fn=reinterpret_cast<PFNGLSECONDARYCOLOR3FPROC_HPP>(_impl::_get_proc_address("glSecondaryColor3f",3,0));
	 fn(red1,green1,blue1);
}
typedef void (*PFNGLSECONDARYCOLOR3FVPROC_HPP)(const GLfloat *);
static inline void SecondaryColor3fv(const GLfloat * v1)
{
	static PFNGLSECONDARYCOLOR3FVPROC_HPP fn=reinterpret_cast<PFNGLSECONDARYCOLOR3FVPROC_HPP>(_impl::_get_proc_address("glSecondaryColor3fv",3,0));
	 fn(v1);
}
...
{
	static PFNGLSECONDARYCOLOR3IPROC_HPP fn=reinterpret_cast<PFNGLSECONDARYCOLOR3IPROC_HPP>(_impl::_get_proc_address("glSecondaryColor3i",3,0));
	 fn(red1,green1,blue1);
}
typedef void (*PFNGLSECONDARYCOLOR3IVPROC_HPP)(const GLint *);
static inline void SecondaryColor3iv(const GLint * v1)
{
	static PFNGLSECONDARYCOLOR3IVPROC_HPP fn=reinterpret_cast<PFNGLSECONDARYCOLOR3IVPROC_HPP>(_impl::_get_proc_address("glSecondaryColor3iv",3,0));
	 fn(v1);
}
...
{
	static PFNGLSECONDARYCOLOR3SPROC_HPP fn=reinterpret_cast<PFNGLSECONDARYCOLOR3SPROC_HPP>(_impl::_get_proc_address("glSecondaryColor3s",3,0));
	 fn(red1,green1,blue1);
}
typedef void (*PFNGLSECONDARYCOLOR3SVPROC_HPP)(const GLshort *);
static inline void SecondaryColor3sv(const GLshort * v1)
{
	static PFNGLSECONDARYCOLOR3SVPROC_HPP fn=reinterpret_cast<PFNGLSECONDARYCOLOR3SVPROC_HPP>(_impl::_get_proc_address("glSecondaryColor3sv",3,0));
	 fn(v1);
}
...
{
	static PFNGLSECONDARYCOLOR3UBPROC_HPP fn=reinterpret_cast<PFNGLSECONDARYCOLOR3UBPROC_HPP>(_impl::_get_proc_address("glSecondaryColor3ub",3,0));
	 fn(red1,green1,blue1);
}
typedef void (*PFNGLSECONDARYCOLOR3UBVPROC_HPP)(const GLubyte *);
static inline void SecondaryColor3ubv(const GLubyte * v1)
{
	static PFNGLSECONDARYCOLOR3UBVPROC_HPP fn=reinterpret_cast<PFNGLSECONDARYCOLOR3UBVPROC_HPP>(_impl::_get_proc_address("glSecondaryColor3ubv",3,0));
	 fn(v1);
}
...
{
	static PFNGLSECONDARYCOLOR3UIPROC_HPP fn=reinterpret_cast<PFNGLSECONDARYCOLOR3UIPROC_HPP>(_impl::_get_proc_address("glSecondaryColor3ui",3,0));
	 fn(red1,green1,blue1);
}
typedef void (*PFNGLSECONDARYCOLOR3UIVPROC_HPP)(const GLuint *);
static inline void SecondaryColor3uiv(const GLuint * v1)
{
	static PFNGLSECONDARYCOLOR3UIVPROC_HPP fn=reinterpret_cast<PFNGLSECONDARYCOLOR3UIVPROC_HPP>(_impl::_get_proc_address("glSecondaryColor3uiv",3,0));
	 fn(v1);
}
...
{
	static PFNGLSECONDARYCOLOR3USPROC_HPP fn=reinterpret_cast<PFNGLSECONDARYCOLOR3USPROC_HPP>(_impl::_get_proc_address("glSecondaryColor3us",3,0));
	 fn(red1,green1,blue1);
}
typedef void (*PFNGLSECONDARYCOLOR3USVPROC_HPP)(const GLushort *);
static inline void SecondaryColor3usv(const GLushort * v1)
{
	static PFNGLSECONDARYCOLOR3USVPROC_HPP fn=reinterpret_cast<PFNGLSECONDARYCOLOR3USVPROC_HPP>(_impl::_get_proc_address("glSecondaryColor3usv",3,0));
	 fn(v1);
}
...
{
	static PFNGLSECONDARYCOLORPOINTERPROC_HPP fn=reinterpret_cast<PFNGLSECONDARYCOLORPOINTERPROC_HPP>(_impl::_get_proc_address("glSecondaryColorPointer",3,0));
...
{
	static PFNGLTEXPARAMETERIIVPROC_HPP fn=reinterpret_cast<PFNGLTEXPARAMETERIIVPROC_HPP>(_impl::_get_proc_address("glTexParameterIiv",3,0));
	 fn(target1,pname1,params1);
}
...
{
	static PFNGLTEXPARAMETERIUIVPROC_HPP fn=reinterpret_cast<PFNGLTEXPARAMETERIUIVPROC_HPP>(_impl::_get_proc_address("glTexParameterIuiv",3,0));
	 fn(target1,pname1,params1);
}
...
{
	static PFNGLVERTEXATTRIB1DPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB1DPROC_HPP>(_impl::_get_proc_address("glVertexAttrib1d",3,0));
	 fn(index1,x1);
}
...
{
	static PFNGLVERTEXATTRIB1DVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB1DVPROC_HPP>(_impl::_get_proc_address("glVertexAttrib1dv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIB1SPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB1SPROC_HPP>(_impl::_get_proc_address("glVertexAttrib1s",3,0));
	 fn(index1,x1);
}
...
{
	static PFNGLVERTEXATTRIB1SVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB1SVPROC_HPP>(_impl::_get_proc_address("glVertexAttrib1sv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIB2DPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB2DPROC_HPP>(_impl::_get_proc_address("glVertexAttrib2d",3,0));
	 fn(index1,x1,y1);
}
...
{
	static PFNGLVERTEXATTRIB2DVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB2DVPROC_HPP>(_impl::_get_proc_address("glVertexAttrib2dv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIB2SPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB2SPROC_HPP>(_impl::_get_proc_address("glVertexAttrib2s",3,0));
	 fn(index1,x1,y1);
}
...
{
	static PFNGLVERTEXATTRIB2SVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB2SVPROC_HPP>(_impl::_get_proc_address("glVertexAttrib2sv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIB3DPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB3DPROC_HPP>(_impl::_get_proc_address("glVertexAttrib3d",3,0));
	 fn(index1,x1,y1,z1);
}
...
{
	static PFNGLVERTEXATTRIB3DVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB3DVPROC_HPP>(_impl::_get_proc_address("glVertexAttrib3dv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIB3SPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB3SPROC_HPP>(_impl::_get_proc_address("glVertexAttrib3s",3,0));
	 fn(index1,x1,y1,z1);
}
...
{
	static PFNGLVERTEXATTRIB3SVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB3SVPROC_HPP>(_impl::_get_proc_address("glVertexAttrib3sv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIB4NBVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB4NBVPROC_HPP>(_impl::_get_proc_address("glVertexAttrib4Nbv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIB4NIVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB4NIVPROC_HPP>(_impl::_get_proc_address("glVertexAttrib4Niv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIB4NSVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB4NSVPROC_HPP>(_impl::_get_proc_address("glVertexAttrib4Nsv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIB4NUBPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB4NUBPROC_HPP>(_impl::_get_proc_address("glVertexAttrib4Nub",3,0));
...
{
	static PFNGLVERTEXATTRIB4NUBVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB4NUBVPROC_HPP>(_impl::_get_proc_address("glVertexAttrib4Nubv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIB4NUIVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB4NUIVPROC_HPP>(_impl::_get_proc_address("glVertexAttrib4Nuiv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIB4NUSVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB4NUSVPROC_HPP>(_impl::_get_proc_address("glVertexAttrib4Nusv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIB4BVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB4BVPROC_HPP>(_impl::_get_proc_address("glVertexAttrib4bv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIB4DPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB4DPROC_HPP>(_impl::_get_proc_address("glVertexAttrib4d",3,0));
	 fn(index1,x1,y1,z1,w1);
}
...
{
	static PFNGLVERTEXATTRIB4DVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB4DVPROC_HPP>(_impl::_get_proc_address("glVertexAttrib4dv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIB4IVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB4IVPROC_HPP>(_impl::_get_proc_address("glVertexAttrib4iv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIB4SPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB4SPROC_HPP>(_impl::_get_proc_address("glVertexAttrib4s",3,0));
	 fn(index1,x1,y1,z1,w1);
}
...
{
	static PFNGLVERTEXATTRIB4SVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB4SVPROC_HPP>(_impl::_get_proc_address("glVertexAttrib4sv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIB4UBVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB4UBVPROC_HPP>(_impl::_get_proc_address("glVertexAttrib4ubv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIB4UIVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB4UIVPROC_HPP>(_impl::_get_proc_address("glVertexAttrib4uiv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIB4USVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIB4USVPROC_HPP>(_impl::_get_proc_address("glVertexAttrib4usv",3,0));
	 fn(index1,v1);
}
typedef void (*PFNGLVERTEXATTRIBI1IPROC_HPP)(GLuint,GLint);
static inline void VertexAttribI1i(GLuint index1,GLint x1)
{
	static PFNGLVERTEXATTRIBI1IPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIBI1IPROC_HPP>(_impl::_get_proc_address("glVertexAttribI1i",3,0));
	 fn(index1,x1);
}
...
{
	static PFNGLVERTEXATTRIBI1IVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIBI1IVPROC_HPP>(_impl::_get_proc_address("glVertexAttribI1iv",3,0));
	 fn(index1,v1);
}
typedef void (*PFNGLVERTEXATTRIBI1UIPROC_HPP)(GLuint,GLuint);
static inline void VertexAttribI1ui(GLuint index1,GLuint x1)
{
	static PFNGLVERTEXATTRIBI1UIPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIBI1UIPROC_HPP>(_impl::_get_proc_address("glVertexAttribI1ui",3,0));
	 fn(index1,x1);
}
...
{
	static PFNGLVERTEXATTRIBI1UIVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIBI1UIVPROC_HPP>(_impl::_get_proc_address("glVertexAttribI1uiv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIBI2IPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIBI2IPROC_HPP>(_impl::_get_proc_address("glVertexAttribI2i",3,0));
	 fn(index1,x1,y1);
}
...
{
	static PFNGLVERTEXATTRIBI2IVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIBI2IVPROC_HPP>(_impl::_get_proc_address("glVertexAttribI2iv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIBI2UIPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIBI2UIPROC_HPP>(_impl::_get_proc_address("glVertexAttribI2ui",3,0));
	 fn(index1,x1,y1);
}
...
{
	static PFNGLVERTEXATTRIBI2UIVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIBI2UIVPROC_HPP>(_impl::_get_proc_address("glVertexAttribI2uiv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIBI3IPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIBI3IPROC_HPP>(_impl::_get_proc_address("glVertexAttribI3i",3,0));
	 fn(index1,x1,y1,z1);
}
...
{
	static PFNGLVERTEXATTRIBI3IVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIBI3IVPROC_HPP>(_impl::_get_proc_address("glVertexAttribI3iv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIBI3UIPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIBI3UIPROC_HPP>(_impl::_get_proc_address("glVertexAttribI3ui",3,0));
	 fn(index1,x1,y1,z1);
}
...
{
	static PFNGLVERTEXATTRIBI3UIVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIBI3UIVPROC_HPP>(_impl::_get_proc_address("glVertexAttribI3uiv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIBI4BVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIBI4BVPROC_HPP>(_impl::_get_proc_address("glVertexAttribI4bv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIBI4SVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIBI4SVPROC_HPP>(_impl::_get_proc_address("glVertexAttribI4sv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIBI4UBVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIBI4UBVPROC_HPP>(_impl::_get_proc_address("glVertexAttribI4ubv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLVERTEXATTRIBI4USVPROC_HPP fn=reinterpret_cast<PFNGLVERTEXATTRIBI4USVPROC_HPP>(_impl::_get_proc_address("glVertexAttribI4usv",3,0));
	 fn(index1,v1);
}
...
{
	static PFNGLWINDOWPOS2DPROC_HPP fn=reinterpret_cast<PFNGLWINDOWPOS2DPROC_HPP>(_impl::_get_proc_address("glWindowPos2d",3,0));
	 fn(x1,y1);
}
typedef void (*PFNGLWINDOWPOS2DVPROC_HPP)(const GLdouble *);
static inline void WindowPos2dv(const GLdouble * v1)
{
	static PFNGLWINDOWPOS2DVPROC_HPP fn=reinterpret_cast<PFNGLWINDOWPOS2DVPROC_HPP>(_impl::_get_proc_address("glWindowPos2dv",3,0));
	 fn(v1);
}
typedef void (*PFNGLWINDOWPOS2FPROC_HPP)(GLfloat,GLfloat);
static inline void WindowPos2f(GLfloat x1,GLfloat y1)
{
	static PFNGLWINDOWPOS2FPROC_HPP fn=reinterpret_cast<PFNGLWINDOWPOS2FPROC_HPP>(_impl::_get_proc_address("glWindowPos2f",3,0));
	 fn(x1,y1);
}
typedef void (*PFNGLWINDOWPOS2FVPROC_HPP)(const GLfloat *);
static inline void WindowPos2fv(const GLfloat * v1)
{
	static PFNGLWINDOWPOS2FVPROC_HPP fn=reinterpret_cast<PFNGLWINDOWPOS2FVPROC_HPP>(_impl::_get_proc_address("glWindowPos2fv",3,0));
	 fn(v1);
}
typedef void (*PFNGLWINDOWPOS2IPROC_HPP)(GLint,GLint);
static inline void WindowPos2i(GLint x1,GLint y1)
{
	static PFNGLWINDOWPOS2IPROC_HPP fn=reinterpret_cast<PFNGLWINDOWPOS2IPROC_HPP>(_impl::_get_proc_address("glWindowPos2i",3,0));
	 fn(x1,y1);
}
typedef void (*PFNGLWINDOWPOS2IVPROC_HPP)(const GLint *);
static inline void WindowPos2iv(const GLint * v1)
{
	static PFNGLWINDOWPOS2IVPROC_HPP fn=reinterpret_cast<PFNGLWINDOWPOS2IVPROC_HPP>(_impl::_get_proc_address("glWindowPos2iv",3,0));
	 fn(v1);
}
typedef void (*PFNGLWINDOWPOS2SPROC_HPP)(GLshort,GLshort);
static inline void WindowPos2s(GLshort x1,GLshort y1)
{
	static PFNGLWINDOWPOS2SPROC_HPP fn=reinterpret_cast<PFNGLWINDOWPOS2SPROC_HPP>(_impl::_get_proc_address("glWindowPos2s",3,0));
	 fn(x1,y1);
}
typedef void (*PFNGLWINDOWPOS2SVPROC_HPP)(const GLshort *);
static inline void WindowPos2sv(const GLshort * v1)
{
	static PFNGLWINDOWPOS2SVPROC_HPP fn=reinterpret_cast<PFNGLWINDOWPOS2SVPROC_HPP>(_impl::_get_proc_address("glWindowPos2sv",3,0));
	 fn(v1);
}
...
{
	static PFNGLWINDOWPOS3DPROC_HPP fn=reinterpret_cast<PFNGLWINDOWPOS3DPROC_HPP>(_impl::_get_proc_address("glWindowPos3d",3,0));
	 fn(x1,y1,z1);
}
typedef void (*PFNGLWINDOWPOS3DVPROC_HPP)(const GLdouble *);
static inline void WindowPos3dv(const GLdouble * v1)
{
	static PFNGLWINDOWPOS3DVPROC_HPP fn=reinterpret_cast<PFNGLWINDOWPOS3DVPROC_HPP>(_impl::_get_proc_address("glWindowPos3dv",3,0));
	 fn(v1);
}
...
{
	static PFNGLWINDOWPOS3FPROC_HPP fn=reinterpret_cast<PFNGLWINDOWPOS3FPROC_HPP>(_impl::_get_proc_address("glWindowPos3f",3,0));
	 fn(x1,y1,z1);
}
typedef void (*PFNGLWINDOWPOS3FVPROC_HPP)(const GLfloat *);
static inline void WindowPos3fv(const GLfloat * v1)
{
	static PFNGLWINDOWPOS3FVPROC_HPP fn=reinterpret_cast<PFNGLWINDOWPOS3FVPROC_HPP>(_impl::_get_proc_address("glWindowPos3fv",3,0));
	 fn(v1);
}
typedef void (*PFNGLWINDOWPOS3IPROC_HPP)(GLint,GLint,GLint);
static inline void WindowPos3i(GLint x1,GLint y1,GLint z1)
{
	static PFNGLWINDOWPOS3IPROC_HPP fn=reinterpret_cast<PFNGLWINDOWPOS3IPROC_HPP>(_impl::_get_proc_address("glWindowPos3i",3,0));
	 fn(x1,y1,z1);
}
typedef void (*PFNGLWINDOWPOS3IVPROC_HPP)(const GLint *);
static inline void WindowPos3iv(const GLint * v1)
{
	static PFNGLWINDOWPOS3IVPROC_HPP fn=reinterpret_cast<PFNGLWINDOWPOS3IVPROC_HPP>(_impl::_get_proc_address("glWindowPos3iv",3,0));
	 fn(v1);
}
...
{
	static PFNGLWINDOWPOS3SPROC_HPP fn=reinterpret_cast<PFNGLWINDOWPOS3SPROC_HPP>(_impl::_get_proc_address("glWindowPos3s",3,0));
	 fn(x1,y1,z1);
}
typedef void (*PFNGLWINDOWPOS3SVPROC_HPP)(const GLshort *);
static inline void WindowPos3sv(const GLshort * v1)
{
	static PFNGLWINDOWPOS3SVPROC_HPP fn=reinterpret_cast<PFNGLWINDOWPOS3SVPROC_HPP>(_impl::_get_proc_address("glWindowPos3sv",3,0));
	 fn(v1);
}}
#endif
